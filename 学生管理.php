...
<body>
<h1 style="text-align: center;color: #000000;">学生账号密码管理</h1>
...
$sql = "select username,password from students where sid='$number'";
...
if (@$_POST["b"] == '添加') {
     ...
     $insert_sql = "insert into students(sid,username,password) values('$num','$YHM','$MM')";
